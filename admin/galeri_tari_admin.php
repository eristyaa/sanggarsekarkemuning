...
<section class="kegiatan-section">
  <div class="kegiatan-card">
    ...
    echo "<a href='hapus_galeri_tari.php?id=" . $foto['id'] . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Hapus foto ini?')\">Hapus</a>";
    echo "</div>";
...
<h3>Tambah Foto/Video</h3>
      <div class="my-4">
      <form class="formgaleri" action="tambah_galeri_tari.php" method="POST" enctype="multipart/form-data" class="mt-3">
        <div class="mb-3">
